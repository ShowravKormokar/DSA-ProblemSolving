...
// Unsolved: Need more knowledge about graph theory and DP optimization techniques, and more practice with similar problems.🚨☠️❌
...
int main()
{
    ...
    string source = "abca";
    string target = "zbxz";
    vector<string> original = {"ab", "ca", "bc", "zx", "bz", "xy"};
    vector<string> changed = {"zx", "bz", "xy", "ab", "ca", "bc"};
    vector<int> cost = {2, 3, 4, 2, 1, 5};
