...
// Solved but help of internet and AI, need more time to fully understand the sloution way and pattern 💀💀
...
/*
TC: O(N^3) where N is the length of the input string `word`. There are at most 27 * 27 * N states, and each state takes O(1) time to compute.
SC: O(N^3) for the memoization table `mem` and the recursion stack.
*/