// Leetcode prob;em 3577 -> Count the Number of Computer Unlocking Permutations
#include <bits/stdc++.h>
using namespace std;
...
{
    Solution sol;
    vector<int> complexity = {3, 4, 5};
    cout << "Result: " << sol.countPermutations(complexity) << endl; // Output: 2
    return 0;
}
