...
{
    Solution sol;
    vector<vector<int>> coins = {{1, -2, 3}, {-4, 5, -6}, {7, -8, 9}};
    cout << sol.maximumAmount(coins) << endl; // Output: 15
    return 0;
}

/*
TC: O(m * n * 3) where m and n are the dimensions of the coins grid.
SC: O(m * n * 4) for the dp array.
*/