// Leetcode problem 3539 -> Find Sum of Array Product of Magical Sequences
#include <bits/stdc++.h>
#include <bit>
using namespace std;
...
private:
    ...
    {
        if (m < 0 || k < 0 || (m + popcount(carry) < k)) // Popcount is undefined
            return 0;
        if (m == 0)
...
int main()
{
    ...
    cout << "Result: " << sol.magicalSum(m, k, nums) << endl;
    return 0;
}