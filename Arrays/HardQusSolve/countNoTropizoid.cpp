// Leetcode problem -> 3625. Count Number of Trapezoids II
#include <bits/stdc++.h>
using namespace std;
...
int main()
{
    ...
    cout << sol.countTrapezoids(points) << endl; // Example usage
    return 0;
}
...
TC: O(n^2)
SC: O(n^2)
This code counts the number of trapezoids formed by given points in a 2D plane
*/