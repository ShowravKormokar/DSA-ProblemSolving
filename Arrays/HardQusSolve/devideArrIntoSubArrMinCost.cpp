...
//Unsolved: need to debug and more knowledge about multisets and spent more time❌☠️🚨
...
/*
TC: O(n log(dist)) where n is the size of nums.
SC: O(dist)
*/