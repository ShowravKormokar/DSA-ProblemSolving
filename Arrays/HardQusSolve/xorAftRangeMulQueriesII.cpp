// Leetcode problem 3655 -> XOR After Range Multiplication Queries II
#include <bits/stdc++.h>
using namespace std;
...
int main()
{
    ...
    vector<vector<int>> queries = {{0, 2, 1, 2}, {1, 3, 2, 3}};
    cout << sol.xorAfterQueries(nums, queries) << endl; // Output: XOR result after applying queries
    return 0;
}

/*
TC: O(n + q * log(q)) where n is the size of nums and q is the number of queries.
SC: O(q) for the diff map storing the multiplicative factors for each query.
*/