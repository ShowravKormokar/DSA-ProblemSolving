// Leetcode probelm 3651 -> Minimum Cost Path with Teleportations
#include <bits/stdc++.h>
using namespace std;

// DP + HashMap + Sorting, Hard to understand Teleportation logic, need more practice ❌☠️🚨😥
...
{
    Solution sol;
    vector<vector<int>> grid = {{5, 1, 2}, {4, 0, 3}, {7, 8, 6}};
    int k = 1;
    cout << sol.minCost(grid, k) << endl; // Output the minimum cost path with teleportations
    return 0;
}
