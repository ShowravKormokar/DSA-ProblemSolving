// Leetcode problem 3321 -> Find X-Sum of All K-Long Subarrays II
#include <bits/stdc++.h>
using namespace std;

// ----------------- Complex problem need more study 🚨☠️ (Unsolved.self)
...
int main()
{
    ...
    for (auto num : sol.findXSum(nums, k, x))
    {
        cout << num << " "; // Output: 6 10 12
    }
    cout << endl;
    return 0;
}
